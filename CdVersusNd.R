...
for( i in 1:length(cd_phases_list)){ cd_phase1_means[i]=mean(cd_phases_list[[i]][[phase1]]$Heart.Rate)}
for( i in 1:length(cd_phases_list)){ cd_phase2_means[i]=mean(cd_phases_list[[i]][[phase2]]$Heart.Rate)}
for( i in 1:length(cd_phases_list)){ cd_phase3_means[i]=mean(cd_phases_list[[i]][[phase3]]$Heart.Rate)}
for( i in 1:length(cd_phases_list)){ cd_phase4_means[i]=mean(cd_phases_list[[i]][[phase4]]$Heart.Rate)}
for( i in 1:length(cd_phases_list)){ cd_phase5_means[i]=mean(cd_phases_list[[i]][[phase5]]$Heart.Rate)}
nd_phase1_means=numeric()
nd_phase2_means=numeric()
nd_phase3_means=numeric()
nd_phase4_means=numeric()
nd_phase5_means=numeric()
for( i in 1:length(nd_phases_list)){ nd_phase1_means[i]=mean(nd_phases_list[[i]][[phase1]]$Heart.Rate)}
for( i in 1:length(nd_phases_list)){ nd_phase2_means[i]=mean(nd_phases_list[[i]][[phase2]]$Heart.Rate)}
for( i in 1:length(nd_phases_list)){ nd_phase3_means[i]=mean(nd_phases_list[[i]][[phase3]]$Heart.Rate)}
for( i in 1:length(nd_phases_list)){ nd_phase4_means[i]=mean(nd_phases_list[[i]][[phase4]]$Heart.Rate)}
for( i in 1:length(nd_phases_list)){ nd_phase5_means[i]=mean(nd_phases_list[[i]][[phase5]]$Heart.Rate)}
...
pdf("HeartRateOutput.pdf",width = 15, height= 15)
par(mfrow=c(3,1))
...
box_ylabel="Heart Rate [bpm] Phase-wise Means"
legend_text="CD"
...
for( i in 1:length(ed_phases_list)){ ed_phase1_means[i]=mean(ed_phases_list[[i]][[phase1]]$Heart.Rate)}
for( i in 1:length(ed_phases_list)){ ed_phase2_means[i]=mean(ed_phases_list[[i]][[phase2]]$Heart.Rate)}
for( i in 1:length(ed_phases_list)){ ed_phase3_means[i]=mean(ed_phases_list[[i]][[phase3]]$Heart.Rate)}
for( i in 1:length(ed_phases_list)){ ed_phase4_means[i]=mean(ed_phases_list[[i]][[phase4]]$Heart.Rate)}
for( i in 1:length(ed_phases_list)){ ed_phase5_means[i]=mean(ed_phases_list[[i]][[phase5]]$Heart.Rate)}
nd_phase1_means=numeric()
nd_phase2_means=numeric()
nd_phase3_means=numeric()
nd_phase4_means=numeric()
...
nostress_color="deepskyblue"
box_title="Differences of means across phases compared to baseline(black)"
box_ylabel="Heart [bpm] Phase-wise Means"
legend_text="ED"
ylim_upper=max(apply(dfphases,2,max,na.rm=TRUE))+5
ylim_lower=min(apply(dfphases,2,min,na.rm=TRUE))-5
bxp=boxplot(dfphases,main=box_title,ylab=box_ylabel,col=c(nostress_color,stress_color,nostress_color,stress_color,nostress_color),ylim = c(ylim_lower,ylim_upper))
...
for( i in 1:length(md_phases_list)){ md_phase1_means[i]=mean(md_phases_list[[i]][[phase1]]$Heart.Rate)}
for( i in 1:length(md_phases_list)){ md_phase2_means[i]=mean(md_phases_list[[i]][[phase2]]$Heart.Rate)}
for( i in 1:length(md_phases_list)){ md_phase3_means[i]=mean(md_phases_list[[i]][[phase3]]$Heart.Rate)}
for( i in 1:length(md_phases_list)){ md_phase4_means[i]=mean(md_phases_list[[i]][[phase4]]$Heart.Rate)}
for( i in 1:length(md_phases_list)){ md_phase5_means[i]=mean(md_phases_list[[i]][[phase5]]$Heart.Rate)}
nd_phase1_means=numeric()
nd_phase2_means=numeric()
nd_phase3_means=numeric()
nd_phase4_means=numeric()
