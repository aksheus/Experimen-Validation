...
for( i in 1:length(cd_phases_list)){ cd_phase1_means[i]=mean(cd_phases_list[[i]][[phase1]]$Breathing.Rate)}
for( i in 1:length(cd_phases_list)){ cd_phase2_means[i]=mean(cd_phases_list[[i]][[phase2]]$Breathing.Rate)}
for( i in 1:length(cd_phases_list)){ cd_phase3_means[i]=mean(cd_phases_list[[i]][[phase3]]$Breathing.Rate)}
for( i in 1:length(cd_phases_list)){ cd_phase4_means[i]=mean(cd_phases_list[[i]][[phase4]]$Breathing.Rate)}
for( i in 1:length(cd_phases_list)){ cd_phase5_means[i]=mean(cd_phases_list[[i]][[phase5]]$Breathing.Rate)}
nd_phase1_means=numeric()
nd_phase2_means=numeric()
nd_phase3_means=numeric()
nd_phase4_means=numeric()
nd_phase5_means=numeric()
for( i in 1:length(nd_phases_list)){ nd_phase1_means[i]=mean(nd_phases_list[[i]][[phase1]]$Breathing.Rate)}
for( i in 1:length(nd_phases_list)){ nd_phase2_means[i]=mean(nd_phases_list[[i]][[phase2]]$Breathing.Rate)}
for( i in 1:length(nd_phases_list)){ nd_phase3_means[i]=mean(nd_phases_list[[i]][[phase3]]$Breathing.Rate)}
for( i in 1:length(nd_phases_list)){ nd_phase4_means[i]=mean(nd_phases_list[[i]][[phase4]]$Breathing.Rate)}
for( i in 1:length(nd_phases_list)){ nd_phase5_means[i]=mean(nd_phases_list[[i]][[phase5]]$Breathing.Rate)}
...
pdf("BreathingRateQQ.pdf",width = 25, height= 15)
par(mfrow=c(3,5))
drive="CD"
qqnorm(phase1_differences,main = "Phase1",ylab="Observed Distribution of Means",xlab="Normal Distribution of Means")
if(shapiro_result1$p.value > alpha_normal){
  qqline(phase1_differences,col="blue")
}else{
  qqline(phase1_differences,col="red")
}
legend(x="topright",legend=drive,bty="n",cex = 1.3)
shapiro_text=paste("Shapiro p-value -",shapiro_result1$p.value,sep=" ")
legend(x="topleft",legend=shapiro_text,bty="n")

qqnorm(phase2_differences,main = "Phase2",ylab="Observed Distribution of Means",xlab="Normal Distribution of Means")
if(shapiro_result2$p.value > alpha_normal){
  qqline(phase2_differences,col="blue")
}else{
  qqline(phase2_differences,col="red")
}
legend(x="topright",legend=drive,bty="n",cex=1.3)
shapiro_text=paste("Shapiro p-value -",shapiro_result2$p.value,sep=" ")
legend(x="topleft",legend=shapiro_text,bty="n")

qqnorm(phase3_differences,main = "Phase3",ylab="Observed Distribution of Means",xlab="Normal Distribution of Means")
if(shapiro_result3$p.value > alpha_normal){
  qqline(phase3_differences,col="blue")
}else{
  qqline(phase3_differences,col="red")
}
legend(x="topright",legend=drive,bty="n",cex=1.3)
shapiro_text=paste("Shapiro p-value -",shapiro_result3$p.value,sep=" ")
legend(x="topleft",legend=shapiro_text,bty="n")

qqnorm(phase4_differences,main = "Phase4",ylab="Observed Distribution of Means",xlab="Normal Distribution of Means")
if(shapiro_result4$p.value > alpha_normal){
  qqline(phase4_differences,col="blue")
}else{
  qqline(phase4_differences,col="red")
}
legend(x="topright",legend=drive,bty="n",cex=1.3)
shapiro_text=paste("Shapiro p-value -",shapiro_result4$p.value,sep=" ")
legend(x="topleft",legend=shapiro_text,bty="n")

qqnorm(phase5_differences,main = "Phase5",ylab="Observed Distribution of Means",xlab="Normal Distribution of Means")
if(shapiro_result5$p.value > alpha_normal){
  qqline(phase5_differences,col="blue")
}else{
  qqline(phase5_differences,col="red")
}
legend(x="topright",legend=drive,bty="n",cex=1.3)
shapiro_text=paste("Shapiro p-value -",shapiro_result5$p.value,sep=" ")
legend(x="topleft",legend=shapiro_text,bty="n")
...
# box_ylabel="Breathing Rate [bpm] Phase-wise Means"
# legend_text="CD"
...
for( i in 1:length(ed_phases_list)){ ed_phase1_means[i]=mean(ed_phases_list[[i]][[phase1]]$Breathing.Rate)}
for( i in 1:length(ed_phases_list)){ ed_phase2_means[i]=mean(ed_phases_list[[i]][[phase2]]$Breathing.Rate)}
for( i in 1:length(ed_phases_list)){ ed_phase3_means[i]=mean(ed_phases_list[[i]][[phase3]]$Breathing.Rate)}
for( i in 1:length(ed_phases_list)){ ed_phase4_means[i]=mean(ed_phases_list[[i]][[phase4]]$Breathing.Rate)}
for( i in 1:length(ed_phases_list)){ ed_phase5_means[i]=mean(ed_phases_list[[i]][[phase5]]$Breathing.Rate)}
nd_phase1_means=numeric()
nd_phase2_means=numeric()
nd_phase3_means=numeric()
nd_phase4_means=numeric()
...
# nostress_color="deepskyblue"
# box_title="Differences of means across phases compared to baseline(black)"
# box_ylabel="Breathing [bpm] Phase-wise Means"
# legend_text="ED"
# ylim_upper=max(apply(dfphases,2,max,na.rm=TRUE))+5
# ylim_lower=min(apply(dfphases,2,min,na.rm=TRUE))-5
# bxp=boxplot(dfphases,main=box_title,ylab=box_ylabel,col=c(nostress_color,stress_color,nostress_color,stress_color,nostress_color),ylim = c(ylim_lower,ylim_upper))
...
for( i in 1:length(md_phases_list)){ md_phase1_means[i]=mean(md_phases_list[[i]][[phase1]]$Breathing.Rate)}
for( i in 1:length(md_phases_list)){ md_phase2_means[i]=mean(md_phases_list[[i]][[phase2]]$Breathing.Rate)}
for( i in 1:length(md_phases_list)){ md_phase3_means[i]=mean(md_phases_list[[i]][[phase3]]$Breathing.Rate)}
for( i in 1:length(md_phases_list)){ md_phase4_means[i]=mean(md_phases_list[[i]][[phase4]]$Breathing.Rate)}
for( i in 1:length(md_phases_list)){ md_phase5_means[i]=mean(md_phases_list[[i]][[phase5]]$Breathing.Rate)}
nd_phase1_means=numeric()
nd_phase2_means=numeric()
nd_phase3_means=numeric()
nd_phase4_means=numeric()
